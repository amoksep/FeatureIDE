...
import de.ovgu.featureide.core.roslaunch.graphconf.FlowImages;
import de.ovgu.featureide.core.roslaunch.graphconf.figures.SimpleActivityLabel;
...
public class SimpleActivityPart extends ActivityPart {
	...
	protected IFigure createFigure() {
		SimpleActivityLabel l = new SimpleActivityLabel();
//		l.setImage(FlowImages.GEAR);
