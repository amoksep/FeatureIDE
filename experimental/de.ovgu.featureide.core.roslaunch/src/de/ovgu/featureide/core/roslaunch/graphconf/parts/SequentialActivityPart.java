...
import de.ovgu.featureide.core.roslaunch.graphconf.figures.SequentialActivityFigure;
...
public class SequentialActivityPart extends StructuredActivityPart {
	...
	/**
	 * @see de.ovgu.featureide.core.roslaunch.graphconf.parts.StructuredActivityPart#createFigure()
	 */
	...
	/**
	 * @see de.ovgu.featureide.core.roslaunch.graphconf.parts.StructuredActivityPart#getAnchorOffset()
	 */
	int getAnchorOffset() {
		return 15;
	}
